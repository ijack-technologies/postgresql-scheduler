...
function activate(context) {
    ...
    const provider = vscode.lm.registerMcpServerDefinitionProvider("rcom-postgres-mcp", {
        provideMcpServerDefinitions: async (token) => {
            return [
                new vscode.McpHttpServerDefinition("PostgreSQL Database", vscode.Uri.parse("http://mcp-postgres:5005/mcp"), {}, // No additional headers needed
                "1.0.0" // Version
                ),
            ];
        },
