...
from project import update_fx_exchange_rates_daily
...
class TestAll(unittest.TestCase):
    ...
    @patch("project.update_fx_exchange_rates_daily.exit_if_already_running")
    def test_update_fx_exchange_rates_daily(self, mock_exit_if_already_running):
        """Test the main program"""
        global c
        update_fx_exchange_rates_daily.main(c)
