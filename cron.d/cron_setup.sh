...
echo "Setting up the cron jobs in /etc/cron.d/sean_jobs"
...
# Send the following crontab to scheduler.txt
echo "SHELL=/bin/bash
...
# Leave the last line blank for a valid cron file" > /etc/cron.d/sean_jobs

# Make the shell scripts executable
# chmod +x /project/cron/truncate_logs.sh

# Set the default crontab as the scheduler.txt file
